...
namespace Core.Algorithm
{
    ...
    public class MeshBuilder
    {
        ...
        public MeshBuilder(float elementSize = 1, int smoothingPasses = 3)
        {
        ...
        public MeshBuilder AddLoop(IEnumerable<Point2> loop)
        {
        ...
        /// </summary>
        /// <param name="firstVertexIndex">First index of the vertex.</param>
        /// <param name="iteration">The iteration.</param>
        /// <param name="progressReport"></param>
        /// <returns></returns>
        private bool IterateMesh(int firstVertexIndex, int iteration, IProgress<TaskProgress> progressReport)
        {
            var lines = new LinkedList<MeshLine>();
            var lastPercent = 0;

            for (var i = firstVertexIndex; i < _vertices.Count; i++)
            {
                ...
                var percentProgress = (int)(100f * (i - firstVertexIndex) / (_vertices.Count - firstVertexIndex));
